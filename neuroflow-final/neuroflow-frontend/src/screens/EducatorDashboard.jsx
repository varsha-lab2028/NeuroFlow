...
import NoneTrendChart from '../components/NoneTrendChart'
      ...
      <div className="content" style={{ paddingTop: 18 }}>
        ...
        {tab === 'trends' && (
          <>
            ...
            {/* ML NONE trend — one per student */}
            {displayStudents.map(s => (
              <NoneTrendChart key={s.studentId} studentId={s.studentId} studentName={s.name} />
            ))}
          </>
        )}
      </div>
