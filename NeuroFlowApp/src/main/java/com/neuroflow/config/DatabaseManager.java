...
public class DatabaseManager {
    ...
    private static final String DB_URL = "jdbc:sqlite:neuroflow.db";
    ...
    private DatabaseManager() {
        try {
            ...
            createTables();
            seedDataIfEmpty();
            System.out.println("[DB] Connected to neuroflow.db");
        } catch (Exception e) {
    ...
    private void seedDataIfEmpty() throws SQLException {
        ...
        ps = connection.prepareStatement("INSERT INTO users(name,role,pin) VALUES(?,?,?)");
        for (String[] u : users) {
        ...
        // Students (user_ids 1-5, parent_id=6, educator_id=7)
        String[][] students = {
        ...
        ps = connection.prepareStatement("INSERT INTO error_patterns(student_id,error_type,week_start,count) VALUES(?,?,?,?)");
        for (String[] e : errors) {
